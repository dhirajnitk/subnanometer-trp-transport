...
$ python diagonalize_matrix.py --help
'''
...
parser.add_argument("-f", required=True, help="Filename of positions and dipole orientations to use")
...
print(f"Thermal QY: {thermal_QY(eigenvalues)}")
